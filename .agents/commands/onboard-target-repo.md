...
### 2. Inspect
- Look for target project configs in `.agents/projects/`. If missing, generate a new configuration based on `.agents/projects/_template.json`.
...
### 3. Output
- Create/update the target configuration file under `.agents/projects/<project-name>.json`.
